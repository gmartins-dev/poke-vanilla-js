...
import { getPokemonTypeOptions } from "../services/pokemon-service.js";
...
export function renderHomeLayout(
	...
	pokemonList,
	{
		...
		totalPages = 1,
		pageSize = 18,
		totalResults = pokemonList.length,
		allPokemon = [],
	} = {},
) {
	...
	const typeOptions = getPokemonTypeOptions(allPokemon);
    ...
    <div class="min-h-screen bg-white text-slate-700">
      ...
      <main class="mx-auto max-w-[1366px] px-4 pt-3 pb-8 sm:px-[18px] sm:pt-4 sm:pb-10">
        ${filterControlsTemplate({
					searchTerm,
					selectedType,
					totalResults: !isLoading && !errorMessage ? totalResults : 0,
					typeOptions,
				})}
        ${statusMarkup}
        ${
